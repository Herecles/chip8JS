...
/* harmony export */ });
/* harmony import */ var _constants_charset_constats__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
/* harmony import */ var _constants_memory_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4);
/* harmony import */ var _constants_registers_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5);
...
class Chip8 {
  ...
  sleep(ms = _constants_registers_constants__WEBPACK_IMPORTED_MODULE_3__.TIMER_60_HZ) {
    return new Promise((resolve) => setTimeout(resolve, ms));
  }

  loadCharSet() {
    this.memory.memory.set(_constants_charset_constats__WEBPACK_IMPORTED_MODULE_0__.CHAR_SET, _constants_memory_constants__WEBPACK_IMPORTED_MODULE_2__.CHAR_SET_ADDRESS);
  }

  loadRom(romBuffer) {
    console.assert(
      romBuffer.length + _constants_memory_constants__WEBPACK_IMPORTED_MODULE_2__.LOAD_PROGRAM_ADDRESS <= _constants_memory_constants__WEBPACK_IMPORTED_MODULE_2__.MEMORY_SIZE,
      'This rom is too large.'
    );
    this.memory.memory.set(romBuffer, _constants_memory_constants__WEBPACK_IMPORTED_MODULE_2__.LOAD_PROGRAM_ADDRESS);
    this.registers.PC = _constants_memory_constants__WEBPACK_IMPORTED_MODULE_2__.LOAD_PROGRAM_ADDRESS;
  }
  ...
  async execute(opcode) {
    ...
    switch (id) {
      ...
      case 'ADD_VX_VY':
        if (this.registers.V[args[0]] + this.registers.V[args[1]] > 0xff) {
          this.registers.V[0x0f] = 1;
        } else {
          this.registers.V[0x0f] = 0;
        }
      ...
      case 'LD_F_VX':
        this.registers.I = this.registers.V[args[0]] * _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.SPRITE_HEIGHT;
        break;
...
/* harmony export */ });
/* harmony import */ var _constants_instructionset_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7);


class Disassembler {
    disassemble(opcode) {
        const instruction = _constants_instructionset_constants__WEBPACK_IMPORTED_MODULE_0__.INSTRUCTION_SET.find(
...
class Display {
  constructor(memory) {
    ...
    this.screen.width = _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.DISPLAY_WIDTH * _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.DISPLAY_MULTIPLY;
    this.screen.height = _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.DISPLAY_HEIGHT * _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.DISPLAY_MULTIPLY;

    this.context = this.screen.getContext('2d');
    this.context.fillStyle = _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.BG_COLOR;
    this.frameBuffer = [];
  ...
  reset() {
    for (let h = 0; h < _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.DISPLAY_HEIGHT; h++) {
      this.frameBuffer.push([]);
      for (let w = 0; w < _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.DISPLAY_WIDTH; w++) {
  ...
  drawPixel(h, w, value) {
    if (value) {
      this.context.fillStyle = _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.COLOR;
    } else {
      this.context.fillStyle = _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.BG_COLOR;
    }

    this.context.fillRect(
      w * _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.DISPLAY_MULTIPLY,
      h * _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.DISPLAY_MULTIPLY,
      _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.DISPLAY_MULTIPLY,
      _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.DISPLAY_MULTIPLY
    );
  }
  ...
  drawSprite(x, y, spriteAddress, size) {
    ...
    for (let line = 0; line < size; line++) {
      ...
      for (let col = 0; col < _constants_charset_constats__WEBPACK_IMPORTED_MODULE_0__.CHAR_SET_WIDTH; col++) {
        const bitToCheck = 0b10000000 >> col;
        const colValue = lineValue & bitToCheck;
        const px = (x + col) % _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.DISPLAY_WIDTH;;
        const py = (y + line) % _constants_display_constants__WEBPACK_IMPORTED_MODULE_1__.DISPLAY_HEIGHT;
        if (colValue === 0) {
          continue;
        }
...
/* harmony export */ });
/* harmony import */ var _constants_keyboard_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(10);


class Keyboard {
  constructor() {
    this.keys = new Array(_constants_keyboard_constants__WEBPACK_IMPORTED_MODULE_0__.NUMBER_OF_KEYS).fill(false);
    document.addEventListener('keydown', (event) => this.keydown(event.key));
    document.addEventListener('keyup', (event) => this.keyup(event.key));
  }

  keydown(key) {
    const keyIndex = _constants_keyboard_constants__WEBPACK_IMPORTED_MODULE_0__.keyMap.findIndex((mapKey) => mapKey === key.toLowerCase());
    if (keyIndex > -1) {
...
/* harmony export */ });
/* harmony import */ var _constants_memory_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);


class Memory {
  constructor() {
    this.memory = new Uint8Array(_constants_memory_constants__WEBPACK_IMPORTED_MODULE_0__.MEMORY_SIZE);
    this.reset();
  }
  ...
  assertMemory(index){
      console.assert(
          index >= 0 && index < _constants_memory_constants__WEBPACK_IMPORTED_MODULE_0__.MEMORY_SIZE, 
...
/* harmony export */ });
/* harmony import */ var _constants_memory_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony import */ var _constants_registers_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(5);



class Registers {
  constructor() {
    this.V = new Uint8Array(_constants_registers_constants__WEBPACK_IMPORTED_MODULE_1__.NUMBER_OF_REGISTERS);
    this.I = 0;
    this.DT = 0;
    this.ST = 0;
    this.PC = _constants_memory_constants__WEBPACK_IMPORTED_MODULE_0__.LOAD_PROGRAM_ADDRESS;
    this.SP = -1;
    this.stack = new Uint16Array(_constants_registers_constants__WEBPACK_IMPORTED_MODULE_1__.STACK_DEEP);
    this.reset();
  }
  ...
  assertStackOverFlow() {
    console.assert(this.SP < _constants_registers_constants__WEBPACK_IMPORTED_MODULE_1__.STACK_DEEP, `Error stack overflow.`);
...
/* harmony export */ });
/* harmony import */ var _constants_audio_soundcard_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(14);
...
class SoundCard {
  constructor() {
    ...
    if ('AudioContext' in window || 'webkitAudioContext' in window) {
      ...
      masterGain.gain.value = _constants_audio_soundcard_constants__WEBPACK_IMPORTED_MODULE_0__.INITIAL_VOLUME;
...
/* harmony import */ var _constants_memory_constants__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(4);
/* harmony import */ var _constants_registers_constants__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(5);
